# @taktikorg/magnam-atque-sint [![NPM version](https://img.shields.io/npm/v/@taktikorg/magnam-atque-sint.svg?style=flat)](https://www.npmjs.com/package/@taktikorg/magnam-atque-sint) [![NPM monthly downloads](https://img.shields.io/npm/dm/@taktikorg/magnam-atque-sint.svg?style=flat)](https://npmjs.org/package/@taktikorg/magnam-atque-sint) [![NPM total downloads](https://img.shields.io/npm/dt/@taktikorg/magnam-atque-sint.svg?style=flat)](https://npmjs.org/package/@taktikorg/magnam-atque-sint)
...
```sh
$ npm install --save @taktikorg/magnam-atque-sint
```
...
```js
const { synonyms } = require('@taktikorg/magnam-atque-sint');
...
```js
const { splitWords } = require('@taktikorg/magnam-atque-sint');
...
```sh
npm install @taktikorg/magnam-atque-sint --global
```
